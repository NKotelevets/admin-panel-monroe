...
const View = () => {
  ...
  const CONNECTED_SEASONS = ['S1', 'S2', 'S3']
        ...
        <Flex className="view-container" vertical>
          ...
          <Flex vertical>
            ...
            <Flex className="field-wrapper">
              ...
              <Typography.Text className="view-text field-value-container">{data?.description || '-'}</Typography.Text>
            </Flex>

            <Flex className="field-wrapper">
              <Typography.Text className="view-text">Welcome Note:</Typography.Text>
              <Typography.Text className="view-text field-value-container">{data?.welcomeNote || '-'}</Typography.Text>
            </Flex>
